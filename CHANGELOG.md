...
This is an experimental library release. Company CLI/MCP sandbox evidence is
not an execution of the library's opt-in sandbox suite. The library does not
implement a customer authentication UI for cards requiring additional action.
SQLite persistence is single-host. See docs/RELEASING.md for release gates.
